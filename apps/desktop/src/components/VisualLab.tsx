...
const buildFacetSvgPrompt = ({
  ...
  [
    ...
    "## Design Principles",
    "",
    "1. SPATIAL SEMANTICS — use regions, borders, and contrasting fills to show structure and boundaries.",
    "2. NESTED CONTAINMENT — place related concepts inside larger bordered regions.",
    "3. MULTIPLE ARROW STYLES — distinguish data flows by color, dash pattern, and stroke width.",
    "4. QUANTITATIVE ANNOTATIONS — include concrete numbers where available.",
    "5. TEXT LABELS — use Chinese for explanatory labels, English for technical terms.",
    "6. CLEAN COMPOSITION — adequate spacing, paper-figure quality.",
    "",
    "## READABILITY (CRITICAL)",
    "",
    "- The FIRST element inside <svg> MUST be a background <rect> covering the full viewBox. Use a light color.",
    "- All <text> elements must have an explicit fill attribute. Use dark text on light backgrounds, light text on dark fills.",
    "- Ensure adequate spacing between text elements to prevent overlap.",
    "- Keep total SVG under 80KB.",
    "",
    "## SVG Conventions",
    "",
    "- Use viewBox to define your coordinate space.",
    "- Use <defs> for reusable gradients, markers, and filters.",
